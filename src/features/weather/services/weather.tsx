...
export class WeatherService {
    ...
    static async fromConfig(config: WeatherWidgetConfig): Promise<Result<WeatherService, Error>> {
        ...
        return ok(new WeatherService(dailyWeatherRepository, geocodeRepository));
    }

    public async getWeatherWidgetProps(config: WeatherWidgetConfig): Promise<Result<WeatherWidgetProps, Error>> {
        const getGeocodeResult = await this.geocodeRepository.getGeocode(config.location);
        ...
        const forecastResult = await this.dailyWeatherRepository.forecastDaily(latitude, longitude, forecastDays);
